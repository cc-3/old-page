...
category: lab
description: >
    Para este laboratorio ustedes aprenderán como compilar y correr un programa en C, y se familiarizarán un poco con la sintaxis del lenguaje.
---
...
[Link del Repositorio](https://classroom.github.com/a/84BXaqkn)
...
gcc tiene varias opciones que se le pueden mandar vía command line, las cuales esperamos ustedes exploren. En este lab, sin embargo, ustedes van a utilizar únicamente -o, que es usado para especificar el nombre del archivo ejecutable que gcc crea. Usando -o, ustedes van a utilizar los siguientes comandos para compilar program.c en un archivo ejecutable llamado program, y después correrlo.
...
En este ejercicio vamos a abrir un archivo de texto y leer su contenido (cosa que aprendieron a hacer en Java el semestre pasado).

En su carpeta de trabajo, ustedes tienen el archivo <b>lector.c</b>. Deben implementar el método main(int argc, char* argv[]) , donde <b>argc</b> es la longitud de los parámetros de con los que se
