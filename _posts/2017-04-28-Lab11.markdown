...
category: lab
description: >
    En este laboratorio van a apender paralelismo a nivel de threads utilizando la liberia openMP en C, paralelismo a nivel de instrucciones utilizando las instrucciones intrinsics de Intel, y deberan terminar su laboratorio de la semana pasada si aun no lo han hecho (pero si ya esta, basta con Ctrl+C, Ctrl+B).
---
